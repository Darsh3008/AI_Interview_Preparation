      ...
      <div className='w-full max-w-6xl bg-white rounded-3xl shadow-2xl grid md:grid-cols-2 overflow-hidden'>
        <motion.div
          ...
          <p className='text-gray-600 mb-10'>
            Practice real interview scenarios powerd by AI.
        ...
        <motion.div
          ...
          <div className='space-y-6'>
            ...
            <div className='relative flex flex-col gap-6'>
              <FaBriefcase className='absolute top-4 left-3 text-gray-400' />
              ...
              <select value={mode}
                ...
                className='w-full py-3 px4
              border border-gray-200 rounded-xl  pl-5 focus:ring-2 focus:ring-green-500 outline-none transition'>

                <option value="Technical">{" "}Technical Interview</option>
                <option value="">{" "}HR Interview</option>
              </select>
