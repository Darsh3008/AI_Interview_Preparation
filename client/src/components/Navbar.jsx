        ...
        <div className='bg-[#f3f3f3] flex justify-center px-4 pt-6'>
            <motion.div
                ...
                <div className='flex items-center gap-3 cursor-pointer'>
                    ...
                    <h1 className='font-semibold hidden md:block text-lg'>AI Interview Preparation</h1>
                </div>
                    ...
                    <div className='relative'>
                        ...
                        {showUserPopup && (
                            <div className='absolute right-0 mt-3 w-48 bg-white shadow-xl border-gray-200 rounded-xl p-4 z-50'>
                                <p className='text-shadow-md text-blue-500 font-medium mb-1'>{userData?.name}</p>
