      ...
      <div className='flex-1 px-6 py-20'>
        <div className='max-w-6xl mx-auto'>
          <div className='flex justify-center mb-6'>
            <div className='bg-gray-100 to-gray-600 text-sm px-4 py-2 rounded-full flex items-center gap-2'>
          ...
          <div className='text-center mb-28'>
            ...
            <motion.p
              ...
              adaptive difficulty and real-time performance evalutions.
            </motion.p>
              ...
              {[
                {
                  ...
                  desc:"Behavioral and communication based evaluaition"
                },
                {
                  img:techImg,
